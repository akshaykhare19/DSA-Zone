/*
Given a street of N houses (a row of houses), each house having K amount 
...
houses. Find the maximum money he can rob.
...
complete the function maximizeMoney() which takes 2 Integers N
 and K as input and returns the answer.
